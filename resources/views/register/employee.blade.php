...
<body class="bg-gray-100 font-sans">
    ...
    <div class="absolute inset-0 bg-gray-900 bg-opacity-50 -z-10">
        <img src="{{ asset('resources/fondo 1.PNG') }}" alt="Login background image"
    ...
    <section class="max-w-md mx-auto p-6 bg-white rounded-lg shadow-lg">
        <img src="/resources/empleado.png" alt="imagen predeterminada" class="w-24 h-24 mx-auto mb-4">

        <h2 class="text-center text-2xl font-semibold mb-4 text-primary">DATOS DE EMPLEADO</h2>
